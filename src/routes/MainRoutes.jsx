...
import LoanPortfolioScreen from 'pages/widget/Reports/LoanPortofolio/LoanPortfolioScreen';
import LoanActiveScreen from 'pages/widget/Reports/LoanPortofolio/LoanActiveScreen';
import ActiveStaffScreen from 'pages/widget/Reports/Staff/ActiveStaff';
import RevenueScreen from 'pages/widget/Reports/Revenue/RevenueActive';
import ProductScreen from 'pages/widget/Reports/Products/Products';
import ClosingScreen from 'pages/widget/Reports/OpenClosing/Closing';
import LoanOfficerPerformanceScreen from 'pages/widget/Reports/LoanOfficerPerformanceScreen/LoanOfficerPerformanceScreen';
import BranchPerformanceScreen from 'pages/widget/Reports/BreanchPerformanceScreen/BreanchPerformanceScreen';
import LoanApprovalScreen from 'pages/widget/Requests/LoanApproval';
import LoanCancellationScreen from 'pages/widget/Requests/LoanCancellation';
import TransactionScreen from 'pages/widget/Requests/Transactions';
import LoanInactiveScreen from 'pages/widget/Reports/LoanPortofolio/LoanInactiveScreen';
import RevenueActiveScreen from 'pages/widget/Reports/Revenue/RevenueActive';
import ActiveExpenseScreen from 'pages/widget/Reports/Expense/ActiveExpense';
import InActiveExpenseScreen from 'pages/widget/Reports/Expense/InaActiveExpense';
import InActiveStaffScreen from 'pages/widget/Reports/Staff/InActiveStaff';
import AgingScreen from 'pages/widget/Reports/Aging/AgingScreen';
  ...
  children: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              path: 'loan__portfolio',
              element: <LoanPortfolioScreen />
            },
            {
              path: 'opening__closing',
              element: <ClosingScreen />
            },
            {
              path: 'loanofficer_performance',
              element: <LoanOfficerPerformanceScreen />
            },
            
            {
              path: 'branch_performance',
              element: <BranchPerformanceScreen />
            },
            {
              path: 'aging_report',
              element: <AgingScreen />
        ...
        },
        {
          ...
          children: [
            {
              path: 'active',
              element: <LoanActiveScreen />
            },
            {
              path: 'inactive',
              element: <LoanInactiveScreen />
            },
          ]
        },
       
        {
          ...
          children: [
            {
              path: 'active',
              element: <ActiveStaffScreen />
            },
            {
              path: 'inactive',
              element: <InActiveStaffScreen />
            },
          ]
        },
        {
...

        {
          ...
          children: [
            {
              path: 'active',
              element: <ActiveExpenseScreen  />
            },
            {
              path: 'inactive',
              element: <InActiveExpenseScreen  />
            },
          ]
        },
...

        {
          ...
          children: [
            ...
            {
              path: 'loan_cancellation',
              element: <LoanCancellationScreen />
            },
            {
              path: 'transactions',
